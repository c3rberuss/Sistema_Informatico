...
public class Inventario_listar extends javax.swing.JDialog {
     ...
     */
    public Inventario_listar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inventario_listar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inventario_listar dialog = new Inventario_listar(new javax.swing.JFrame(), true);
